...
public class FrmManteProd extends JFrame {
	...
	public FrmManteProd() {
		...
		cboProveedores.setBounds(305, 106, 108, 23);
	...
	void llenaCombo() {
		...
		List<Categoria> lstCategoria = em.createQuery(jpql, Categoria.class).getResultList();
	...
	void listado() {
		...
		for (Producto p : lstProducto) {
			...
			imprimir("Descripcion...: " + p.getDes_prod() + " " + p.getStk_prod());
